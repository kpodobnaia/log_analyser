...
from log_analyser.readers.csv import csv_log_parser
...
def test_csv_log_parser_parses_data_correctly(mock_csv_reader):
    ...
    logs_generator = csv_log_parser(mocked_path)

    result = next(logs_generator)
...
@patch("csv.reader")
@patch("log_analyser.readers.csv.logger")
